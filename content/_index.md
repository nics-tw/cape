...
<div style="display: flex; justify-content: center; align-items: center; gap: 20px; margin: 30px 0; padding: 20px; background: #f5f5f5; border-radius: 10px;">
  <img src="/nics-dp/images/dp_logo_2.png" alt="DP Logo" style="width: 100px; height: auto;">
  <img src="/nics-dp/images/dp_logo_2_black.png" alt="DP Logo Black" style="width: 100px; height: auto;">
  <img src="/nics-dp/images/dp_logo_2_white.png" alt="DP Logo White" style="width: 100px; height: auto; background: #333; padding: 10px; border-radius: 5px;">
</div>
